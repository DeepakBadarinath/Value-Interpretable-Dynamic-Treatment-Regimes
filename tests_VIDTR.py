...
class VIDTR_grid:
    ...
    def __init__(self, dimensions, center, side_lengths, stepsizes, max_lengths,
        ...
        self.VIDTR_MDP = MDP(self.states, self.actions, time_horizon, gamma,
                             transitions, rewards)
...
print(grid_class.algo.MDP.states)
...
'''
states = disjoint_box_union.DBUIterator(grid_class.algo.MDP.states)
